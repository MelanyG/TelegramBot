...
#curl -X POST -d @data.json -H "Content-Type: application/json" "https://api.telegram.org/bot532052987:AAHAFNUmPxAqymKqc32ISGtOYDh_T_Rig38/setWebhook"

class MelanyBot
  TELEGRAM_API_KEY = '532052987:AAHAFNUmPxAqymKqc32ISGtOYDh_T_Rig38'
